...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* BACK TEXT */}
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 text-center bottom-1/3"> 
        <div
          ref={line1Ref}
          className="font-black text-[clamp(2rem,12vw,8.5rem)] tracking-tight text-white/20 "
        >
            <h1 className="flex items-baseline gap-30">
              <span className="text-lime-400 ">Train</span>
              <span className="text-white">with</span>
            </h1>                                  
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-30 pointer-events-none text-center ">
        ...
        <h1 className="font-black text-[clamp(2rem,12vw,8.5rem)] tracking-tight -mt-4 flex items-baseline gap-30">
          <span className="text-white">the</span>{' '}
          <span className="text-lime-400">best.</span>
        </h1>
      </div>
